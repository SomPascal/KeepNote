...
class ChangePswd implements FilterInterface
{
    /**
    ...
    public function before(RequestInterface $request, $arguments = null)
    {
        ...
        if (url_is(route_to("auth.change_password")))
        {
            ...
            $config = (object) (new Throttler())->change_password;
            ...
            $current_password = $request->getJsonVar("current_password", filter: FILTER_SANITIZE_FULL_SPECIAL_CHARS) ?? "";
            $password = $request->getJsonVar("password", filter: FILTER_SANITIZE_FULL_SPECIAL_CHARS) ?? "";
            $password_confirm = $request->getJsonVar("password_confirmation", filter: FILTER_SANITIZE_FULL_SPECIAL_CHARS) ?? "";
            ...
            try {
                if ($validator->run($validate_data, "change_password") === false)
                {
